...
// GetQuery возвращает текущуб сумму
...
// PostQuery добавляет новое число в бд и пересчитывает сумму
...
// PutCount исправляет последнее число в бд и пересчитывает сумму
